  ...
  <tbody>
    <?php 
      ...
      while($row = mysqli_fetch_assoc($result)){
        ...
        <td>". $row['Address'] . "</td>
        <td> <button class='accept btn btn-sm btn-primary' id=".$row['Sno'].">Accept</button> <button class='reject btn btn-sm btn-primary' sid=d".$row['Sno'].">Reject</button>  <button class='delete btn btn-sm btn-primary' id=".$row['Sno'].">Delete</button></td>
      </tr>";
    } 
      ?>
