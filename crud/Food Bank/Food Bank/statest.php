    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="log.php">Donate</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="/crud/statest.php">Status</a>
          </li>
          <li class="nav-item">
...
<table class="table" id="myTable">
  ...
  <tbody>
    <?php 
      ...
      ?>
      <h4 style="text-align:center">LIST OF DONATIONS AND THEIR STATUS</h4>
    </tbody>
    </table>
  </div>
  <hr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mx-auto mb-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="my-2"><a href="about.php">About</a></li>
