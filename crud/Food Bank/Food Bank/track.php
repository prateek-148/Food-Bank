...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="track.php">Tracking <span class="sr-only">(current)</span></a>
        </li>
...
if(isset($_POST['Out']))
{
	$tracking="Out for Pickup";
	
	$sno=$_POST['sno'];
	
	 $query="UPDATE `donator` set `tracking`='$tracking' where `sno`='$sno'";
...
<!------end header here --------->
<div class="container">
<h3 style="padding-top: 25px; text-align:center">UPDATE TRACKING</h3>
...
<table class="table table-striped table-hover ">
  ...
  <?php 
  $i=1;
  $query="Select * from `donator` where `Preference`= 'Pickup' and `Status`='Approved'";
	$res=mysqli_query($conn, $query);
    ...
    <tr>
      ...
      <td><?php echo $row['Mobile'];?></td>
		  ...
		  <td><?php echo $row['Address'];?></td>
			<td style="color:green;"><?php echo $row['tracking'];?></td>
      
			<td><form method="post" action="" >
			</td>
			<input type="hidden" name="sno" value="<?php echo $row['sno'];?>">
			<td> 
			<button type="submit" name="Out" class="btn btn-primary">Out for Pickup</button>
			<button type="submit" name="Picked" class="btn btn-primary">Picked</button>
            <button type="submit" name="Delivered" class="btn btn-primary">Delivered</button>
			</form></td>
    </tr>
	<?php $i++;}}else{
