...
if (isset( $_POST['snoEdit'])){
  // Update the record
    ...
    $query = $_POST["queryEdit"];

  // Sql query to be executed
  $sql = "UPDATE `query` SET `name` = '$name' , `mobile` = '$mobile' , `subject` = '$subject', `query` = '$query' WHERE `donator`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `query` (`name`, `mobile`, `subject`, `query`) VALUES ('$name', '$mobile', '$subject', '$query')";
  $result = mysqli_query($conn, $sql);
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="log.php">Donate</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="/crud/Food Bank/Food Bank/statest.php">Status</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="/crud/Food Bank/Food Bank/query.php">Raise Query</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container my-4">
    ...
    <form action="/crud/Food Bank/Food Bank/query.php" method="POST">
