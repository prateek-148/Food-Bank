...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `donator` SET `name` = '$name' , `mobile` = '$mobile' , `item` = '$item', `description` = $description, `address` = '$address',WHERE `donator`.`sno` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `donator` (`name`, `mobile`, `item`, `description`, `address`) VALUES ('$name', '$mobile', '$item', '$description', '$address')";
  $result = mysqli_query($conn, $sql);
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/crud/statest.php">Status</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container my-4">
    ...
    <form action="/crud/log.php" method="POST">
